...
<div class="row">
    <div class="col-12">
        <div class="filter-container p-0 row">
            <?php
                $media_list = cms::get_content('media?_fields=id,date,alt_text,media_type,author,source_url');
                    ...
                    ?>
                        <div class="filtr-item col-sm-1" data-category="1" data-sort="<?= $media['alt_text'] ?>">
                            <a href="media.php?id=<?= $media['id'] ?>" data-toggle="lightbox" data-title="Attachment Details" data-width="1024">
                                <img src="<?= $media['source_url'] ?>" class="img-fluid mb-2" alt="<?= $media['alt_text'] ?>" style="width: 100%; aspect-ratio: 1 / 1; object-fit: cover;"/>
                            </a>
                        </div>
                    <?php
                }
